...
namespace Drupal\ksp_filelibrary\Plugin\media\Source;
 ...
 * )
 */
class Html extends MediaSourceBase {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    return parent::createSourceField($type)->set('settings', ['file_extensions' => 'html']);
  }
